...
function EditProfilePage() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#0e1513]">
      ...
      <div className="flex min-h-[calc(100vh-80px)]">
        ...
        <main className="flex-1 p-6 md:px-12 lg:px-16 max-w-7xl mx-auto bg-[#0e1513] flex flex-col justify-center">
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#dde4e1] mb-2 tracking-tight">Perfil de <span className="text-[#4fdbc8]">Usuario</span></h1>
            <p className="text-[#bbcac6] text-lg max-w-2xl leading-relaxed">Gestiona tu identidad y preferencias en Vecilend.</p>
          </header>
              ...
              <div className="bg-[#2f3634]/40 backdrop-blur-md rounded-xl p-8 border border-[#3c4947]/20 shadow-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input name="telefon" value={formData.telefon} onChange={handleChange} className="w-full bg-[#161d1b] border border-[#3c4947] rounded-lg px-4 py-3 text-[#dde4e1] focus:border-[#4fdbc8] outline-none transition-all" type="text" placeholder="600 000 000" />
                  </div>
