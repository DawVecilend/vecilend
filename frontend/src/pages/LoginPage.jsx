        ...
        <main className="grow flex flex-col md:flex-row md:h-full overflow-hidden">
            <section className="hidden md:flex md:w-1/2 relative bg-[#090f0e] items-center justify-center h-full overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg px-8">
                    <div className="bg-[#1a211f]/60 backdrop-blur-xl border border-[#3c4947] p-8 rounded-xl shadow-2xl">
                        ...
                        “Vecilend me ha ayudado a encontrar justo lo que necesitaba sin tener que comprarlo. Es fácil de usar, cercano y da mucha confianza saber que los productos están compartidos por vecinos de mi zona.”
                        </p>
            ...
            <section className="flex-1 flex flex-col justify-center px-6 md:px-24 bg-[#0e1513]">
                <div className="max-w-md mx-auto w-full -mt-12">
                    <div className="mb-8">
                        <h1 className="text-4xl font-extrabold text-[#dde4e1] tracking-tight mb-2">Bienvenido/a</h1>
                        <p className="text-[#859490] text-lg">Inicia sesión para acceder a tu comunidad.</p>
                    </div>
                    ...
                    <div className="relative flex items-center justify-center mb-8">
                        ...
                        <span className="mx-4 text-xs font-bold text-[#859490] uppercase tracking-widest">O iniciar con</span>
                        <div className="flex-grow border-t border-[#3c4947]"></div>
                    </div>

                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-1.5">
                            <label className="block text-sm font-semibold text-[#bbcac6]">Usuario / Email</label>
                            <input value={formData.login} onChange={(e) => setFormData({ ...formData, login: e.target.value })} className="w-full bg-[#161d1b] border border-[#3c4947] rounded-lg px-4 py-3 text-[#dde4e1] focus:ring-2 focus:ring-[#4fdbc8] focus:border-transparent outline-none transition-all" placeholder="Nombre de usuario o email" type="text" required />
                        </div>
                        
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center">
                                <label className="block text-sm font-semibold text-[#bbcac6]">Contraseña</label>
                                <Link to="#" className="text-xs font-bold text-[#4fdbc8] hover:underline">¿Olvidaste tu contraseña?</Link>
                            </div>
                            <input value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} className="w-full bg-[#161d1b] border border-[#3c4947] rounded-lg px-4 py-3 text-[#dde4e1] focus:ring-2 focus:ring-[#4fdbc8] focus:border-transparent outline-none transition-all" placeholder="••••••••" type="password" required />
                        </div>
                        ...
                        >
                            ...
                            {!submitting && <span className="material-symbols-outlined text-xl">login</span>}
                        </button>
                    </form>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[#859490] text-sm">
                            ¿No tienes cuenta?{' '}
                            <Link to="/register" className="text-[#4fdbc8] font-bold hover:underline">
                                Crea una aquí
                            </Link>
                        </p>
                    </div>
