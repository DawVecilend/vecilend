...
function SettingsPage() {
  ...
  const editProfilePath = user ? `/settings/profile/${user.username}/editing` : '#';
      ...
      <div className="flex min-h-[calc(100vh-80px)]">
        <aside className="hidden md:flex flex-col p-4 bg-[#090f0e] w-64 border-r border-[#3c4947] transition-all duration-150 font-inter text-sm z-40">
            ...
            <nav className="space-y-1">
                <Link to="/settings" className="flex items-center gap-3 px-3 py-3 bg-[#4fdbc8]/10 text-[#4fdbc8] font-semibold border-r-4 border-[#4fdbc8] transition-all duration-150">
                    <span className="material-symbols-outlined">home</span>
                    <span>Página principal</span>
                </Link>
                <Link to={editProfilePath} className="flex items-center gap-3 px-3 py-3 text-[#859490] hover:bg-[#161d1b] hover:text-[#dde4e1] transition-all duration-150">
        ...
        <main className="flex-1 p-6 md:px-12 lg:px-16 max-w-7xl mx-auto bg-[#0e1513] flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link to={editProfilePath} className="bg-[#2f3634]/40 backdrop-blur-md border border-[#859490]/10 group p-8 rounded-xl flex flex-col justify-between hover:border-[#4fdbc8]/40 transition-all duration-300 cursor-pointer active:scale-[0.98]">
              <div>
            ...
            <div className="bg-[#2f3634]/40 backdrop-blur-md border border-[#859490]/10 group p-8 rounded-xl flex flex-col justify-between hover:border-[#4fdbc8]/40 transition-all duration-300 cursor-pointer active:scale-[0.98]">
              <div>
            ...
            <div className="bg-[#2f3634]/40 backdrop-blur-md border border-[#859490]/10 group p-8 rounded-xl flex flex-col justify-between hover:border-[#4fdbc8]/40 transition-all duration-300 cursor-pointer active:scale-[0.98] md:col-span-2 lg:col-span-1">
              <div>
