      ...
      <div className="flex min-h-[calc(100vh-80px)]">
        ...
        <main className="flex-1 p-6 md:px-12 lg:px-16 max-w-7xl mx-auto bg-app-bg flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-app-text-secondary text-sm leading-relaxed mb-6">
                  Gestiona tus datos de contacto, tu nombre legal y la
                  apariencia de tu perfil público en la comunidad de Vecilend.
                </p>
              </div>
            ...
            <Link
              to={`/settings/profile/${user?.username}/notifications`}
              className="bg-[#2f3634]/40 backdrop-blur-md border border-[#859490]/10 group p-8 rounded-xl flex flex-col justify-between hover:border-[#4fdbc8]/40 transition-all duration-300 cursor-pointer active:scale-[0.98] md:col-span-2 lg:col-span-1"
            >
              <div>
                ...
                <p className="text-app-text-secondary text-sm leading-relaxed mb-6">
                  Administra tus alertas, notificaciones push y permisos de
                  dispositivo como cámara o ubicación para mejorar tu
                  experiencia.
                </p>
              </div>
              <div className="flex items-center text-[#4fdbc8] font-semibold text-sm group-hover:gap-2 transition-all">
