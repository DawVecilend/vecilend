      ...
      <section className="py-24 px-8 md:px-24 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          <div className="w-full md:w-1/2">
            <span className="text-[#9fd0c6] font-bold font-inter mb-4 block uppercase tracking-widest text-sm">
              La seguridad es lo primero
            </span>
            <h2 className="font-inter text-4xl md:text-5xl font-bold mb-8 leading-tight text-[#dee4e1]">
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-xl mb-2 text-[#dee4e1]">
                    Protección Fluid
                  </h4>
                  <p className="text-[#bbcac6]">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="relative bg-[#0a0f0e] p-8 rounded-xl shadow-2xl border border-[#3c4947]/10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="font-bold text-lg text-[#dee4e1]">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-sm font-medium text-[#dee4e1]">
                  <span className="material-symbols-outlined text-[#ffb59e] text-lg">
                    check_circle
                  </span>
      ...
      <section className="py-24 px-8 md:px-24">
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#0052d0] to-[#799dff] rounded-xl p-12 md:p-24 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <Link
              to="/objects/create"
              className="bg-white text-[#0052d0] px-12 py-5 rounded-full font-bold text-xl shadow-2xl hover:scale-105 transition-transform active:scale-95"
            >
              Publicar producto
            </Link>
          </div>
