...
function RegisterPage() {
  ...
  return (
    <div className="bg-[#0e1513] text-[#dde4e1] antialiased min-h-screen md:h-screen md:overflow-hidden flex flex-col dark">
          ...
          <section className="flex-1 flex flex-col justify-center px-6 py-6 md:px-24 bg-[#0e1513]">
            <div className="max-w-md mx-auto w-full">
              ...
              <form className="space-y-4" onSubmit={handleContinue}>
                <div>
                  <label className="block text-sm font-semibold text-[#bbcac6] mb-1.5">Usuario</label>
                  <input name="username" value={formData.username} onChange={handleChange} className="w-full bg-[#161d1b] border border-[#3c4947] rounded-lg px-4 py-2.5 text-[#dde4e1] focus:ring-2 focus:ring-[#4fdbc8] focus:border-transparent outline-none transition-all" placeholder="Nombre de usuario" type="text" required />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-[#bbcac6] mb-1.5">Email</label>
                  <input name="email" value={formData.email} onChange={handleChange} className="w-full bg-[#161d1b] border border-[#3c4947] rounded-lg px-4 py-2.5 text-[#dde4e1] focus:ring-2 focus:ring-[#4fdbc8] focus:border-transparent outline-none transition-all" placeholder="correo@ejemplo.com" type="email" required />
                </div>
                ...
                <button className={`w-full bg-[#4fdbc8] text-[#003731] font-bold py-3.5 rounded-lg shadow-lg shadow-[#4fdbc8]/20 transition-all flex items-center justify-center gap-2 mt-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[#14b8a6] active:scale-[0.97]'}`} type="submit" disabled={isLoading}>
                  <span>{isLoading ? 'Comprobando datos...' : 'Continue to Step 2'}</span>
                  {!isLoading && <span className="material-symbols-outlined text-xl">arrow_forward</span>}
                </button>
              </form>
              
              <p className="mt-6 text-center text-xs text-[#859490] leading-relaxed">
      ...
      {step === 2 && (
        <main className="flex-grow flex flex-col items-center justify-center px-4 pt-28 md:pt-20 pb-12 md:pb-0 md:h-full">
            ...
            <div className="bg-[#1a211f] rounded-xl p-8 border border-[#3c4947] shadow-2xl relative">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-2 text-center">
                  <p className="text-xs text-[#bbcac6] mb-2">Didn't receive the email?</p>
                  <button className="inline-flex items-center gap-1 text-[#4fdbc8] font-semibold text-sm hover:underline active:scale-95 transition-transform">
                    <span className="material-symbols-outlined text-[18px]">refresh</span> Resend Email
                  </button>
                </div>
              </div>
            </div>
      ...
      {step === 3 && (
        <main className="flex-grow flex flex-col items-center justify-center pt-24 pb-12 px-4 md:pt-28 md:pb-8 h-full">
          <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-6 lg:gap-8 items-stretch justify-center h-full">
            
            <div className="w-full md:w-2/3 flex flex-col justify-center h-full relative">
              <div id="final-form-card" className="w-full h-full bg-[#1a211f] border border-[#3c4947]/30 rounded-xl p-6 shadow-2xl relative overflow-hidden flex flex-col">
                ...
                <div className="mb-4 lg:mb-5 mt-2">
                ...
                <form className="space-y-3 lg:space-y-4 flex flex-col flex-1" onSubmit={handleFinalSubmit}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4">
                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">First Name (Nom) *</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">person</span>
                        <input name="nom" value={formData.nom} onChange={handleChange} required className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" placeholder="John" type="text" />
                      </div>
                    </div>

                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">Last Name (Cognoms) *</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">badge</span>
                        <input name="cognoms" value={formData.cognoms} onChange={handleChange} required className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" placeholder="Doe" type="text" />
                      </div>
                    </div>

                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">Password *</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">lock</span>
                        <input name="password" value={formData.password} onChange={handleChange} required className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" placeholder="••••••••" type="password" />
                      </div>
                    </div>

                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">Confirm Password *</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">lock_reset</span>
                        <input name="password_confirmation" value={formData.password_confirmation} onChange={handleChange} required className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" placeholder="••••••••" type="password" />
                      </div>
                    </div>

                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">City/State (Población)</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">location_on</span>
                        <input 
                          name="direccio" 
                          ...
                          className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" 
                    ...
                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-[#bbcac6] ml-1">Phone Number</label>
                      <div className="relative group">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#859490] group-focus-within:text-[#4fdbc8] transition-colors">call</span>
                        <input name="telefon" value={formData.telefon} onChange={handleChange} className="w-full bg-[#2f3634] border-none rounded-lg pl-10 pr-4 py-2 lg:py-2.5 focus:ring-2 focus:ring-[#4fdbc8] text-[#dde4e1] placeholder:text-[#859490]/50 outline-none transition-all" placeholder="+34 600 000 000" type="tel" />
                      </div>
                    </div>
                  ...
                  <div className="mt-auto pt-2 flex flex-col sm:flex-row gap-3">
                    <button onClick={() => setStep(2)} className="flex-1 px-6 py-3 rounded-xl border border-[#3c4947] text-[#dde4e1] font-semibold hover:bg-[#2f3634] transition-all active:scale-[0.98]" type="button">
                      Back to Step 2
                    </button>
                    <button disabled={isLoading} className={`flex-1 px-6 py-3 rounded-xl bg-[#4fdbc8] text-[#003731] font-bold shadow-lg shadow-[#4fdbc8]/20 transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:brightness-110 active:scale-[0.98]'}`} type="submit">
