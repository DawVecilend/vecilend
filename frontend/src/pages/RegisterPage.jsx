        ...
        <main className="grow flex flex-col md:flex-row md:h-full overflow-hidden">
          ...
          <section className="flex-1 flex flex-col justify-center px-6 md:px-24 bg-[#0e1513]">
            <div className="max-w-md mx-auto w-full -mt-12">
              <div className="mb-8">
                <h1 className="text-4xl font-extrabold text-[#dde4e1] tracking-tight mb-2">Crear cuenta</h1>
                <p className="text-[#859490] text-lg">Únete a la comunidad de profesionales de élite hoy.</p>
              </div>
              ...
              <div className="relative flex items-center justify-center mb-8">
                  ...
                  <span className="mx-4 text-xs font-bold text-[#859490] uppercase tracking-widest">O usar cuenta</span>
                  <div className="flex-grow border-t border-[#3c4947]"></div>
              </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-[#859490] text-sm">
                  ¿Tienes cuenta?{' '}
                  <Link to="/login" className="text-[#4fdbc8] font-bold hover:underline">
                    Inicia sesión
                  </Link>
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
                      ...
                      <div className="md:col-span-2 flex items-end">
                        <div className="flex-grow space-y-1">
                          <label className="block text-xs font-medium text-[#bbcac6] ml-1">Profile Picture (Optional)</label>
                          <div className="flex items-center gap-4">
