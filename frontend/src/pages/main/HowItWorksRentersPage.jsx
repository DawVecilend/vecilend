    ...
    <div className="font-inter text-[#dde4e1] min-h-screen antialiased">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="bg-[#252b2a] text-[#bbcac6] px-10 py-4 rounded-full font-bold text-lg hover:bg-[#2f3634] transition-colors"
              >
                ¿Propietario?
              </Link>
            </div>
      ...
      <section className="py-16 bg-app-bg-secondary">
        <div className="max-w-7xl mx-auto">
          <div className=" mb-10">
            <h2 className="text-4xl font-extrabold mb-4 text-[#dde4e1]">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="group bg-vecilend-dark-bg p-10 rounded-lg transition-all duration-300 border border-vecilend-dark-border">
              ...
              <h3 className="text-2xl font-bold mb-4 text-vecilend-dark-text">
                1. Busca
              </h3>
      ...
      <section className="py-24 px-8 max-w-7xl mx-auto">
        <h2 className="text-4xl font-extrabold mb-12 text-center text-[#dde4e1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-8 bg-[#090f0e] rounded-lg p-10 flex flex-col md:flex-row gap-8 items-center overflow-hidden border border-[#3c4947]">
            <div className="flex-1">
              <span className="text-[#4fdbc8] font-bold tracking-widest text-xs uppercase mb-2 block">
                Tranquilidad total
              </span>
              <h3 className="text-3xl font-bold mb-4 text-[#dde4e1]">
                Seguro Todo Riesgo
              </h3>
          ...
          <div className="md:col-span-4 bg-[#4fdbc8] text-[#003731] rounded-lg p-10 flex flex-col justify-between">
            ...
            <Link
              to="#"
              className="mt-8 font-bold flex items-center gap-2 group"
            >
              Saber más{" "}
          ...
          <div className="md:col-span-4 bg-[#21514a] text-[#92c2b8] rounded-lg p-10">
            ...
            <p className="text-[#92c2b8]/80 font-medium">
          ...
          <div className="md:col-span-8 bg-[#252b2a] border border-[#3c4947] rounded-lg p-10 flex items-center gap-8">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 text-[#dde4e1]">
                Soporte 24/7
              </h3>
              <p className="text-[#bbcac6]">
      ...
      <section className="py-24 px-8 md:px-24 bg-[#171d1b]">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-inter text-4xl font-bold text-center mb-16 text-[#dee4e1]">
      ...
      <section className="px-8 py-12">
        <div className="max-w-7xl mx-auto bg-[#4fdbc8] rounded-xl p-12 md:p-20 relative overflow-hidden text-center text-[#003731]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-[#003731]/80 mb-12 max-w-xl mx-auto">
              Únete a miles de personas que ya están ahorrando dinero y cuidando
              el planeta compartiendo en lugar de comprar.
            </p>
            <Link
              to="/objects"
              className="bg-[#090f0e] text-[#4fdbc8] px-12 py-5 rounded-full font-bold text-xl hover:scale-105 transition-transform shadow-2xl"
            >
              Explorar Ahora
            </Link>
          </div>
