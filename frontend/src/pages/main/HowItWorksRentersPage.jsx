    ...
    <div className="font-inter text-app-text min-h-screen antialiased">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          {/* Small Feature 1 */}
          <div className="md:col-span-4 bg-app-primary text-[var(--color-app-success-on)] rounded-lg p-10 flex flex-col justify-between">
            <div>
      ...
      <section className="px-8 py-12">
        <div className="max-w-7xl mx-auto bg-app-primary rounded-xl p-12 md:p-20 relative overflow-hidden text-center text-[var(--color-app-success-on)]">
          ...
          <div className="relative z-10">
            ...
            <Link
              to="/objects"
              className="inline-flex items-center justify-center bg-white text-app-primary px-8 md:px-12 py-4 md:py-5 rounded-full font-bold text-lg md:text-xl shadow-2xl hover:scale-105 transition-transform active:scale-95"
            >
              Explorar Ahora
            </Link>
          </div>
