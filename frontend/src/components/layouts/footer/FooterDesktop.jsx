    ...
    <footer className="flex h-[226px] items-center justify-center bg-vecilend-dark-bg-secondary">
      <div className="mx-auto flex items-start justify-around gap-75">
        <div className="flex min-w-[180px] flex-col">
          ...
          <Link to="/sobre-nosotros" className="mb-[9px] font-body text-body-base text-vecilend-light-text-secondary hover:text-vecilend-dark-primary">
            Sobre Nosotros
          </Link>
        ...
        <div className="flex min-w-[180px] flex-col items-start">
          ...
          <a href="#" className="mb-[9px] font-body text-body-base text-vecilend-light-text-secondary hover:text-vecilend-dark-primary">
            Instagram
          </a>
