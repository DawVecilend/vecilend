...
function CategoryPill({ id, name, icon }) {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-full flex items-center justify-center bg-vecilend-dark-primary/10 group-hover:bg-vecilend-dark-primary/20 group-hover:scale-110 transition-all duration-300 shrink-0">
